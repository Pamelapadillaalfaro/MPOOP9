...
public class Perro extends Mascota{
    ...
    /**
     * Método que hace respirar al perro
     */
    @Override
    public void respirar(){
        System.out.println("Estoy respirando en el jardín");
    }
    /**
    ...
    @Override
    public void dormir(){
        System.out.println("Zzzzzz *soñando con morder hueso*");
    }
    /**
    ...
    /**
     * Método que hace saltar al perro
     */
    @Override
    public void saltar(){
        System.out.println("Estoy saltando un obstáculo");
    }
    /**
